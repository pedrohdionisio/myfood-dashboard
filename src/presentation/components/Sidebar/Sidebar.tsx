...
import {
	...
	TooltipProvider,
	TooltipTrigger
} from 'presentation/components/Tooltip/Tooltip';
...
import { SIDEBAR_OPEN_STORAGE_KEY } from 'shared/constants/storage';
...
function loadStoredOpen(defaultOpen: boolean) {
...
export function SidebarProvider({
	...
	const [internalOpen, setInternalOpen] = useState(() => loadStoredOpen(defaultOpen));
	...
	const contextValue = useMemo<ISidebarContextValue>(
		() => ({
			state,
			open,
			setOpen,
